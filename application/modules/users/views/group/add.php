...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h4 fw-bold mb-1" style="color: var(--text-primary);">
            <i class="fas fa-plus-circle me-2" style="color: var(--primary);"></i>Nouveau Groupe
        </h1>
        <p class="mb-0 small" style="color: var(--text-secondary);">Définissez le nom et les permissions du nouveau groupe</p>
    </div>
        ...
        <div style="background: var(--bg-white); border: 1px solid var(--border-color); border-radius: var(--radius-lg); overflow: hidden;">
            ...
            <div style="padding: 1.25rem 2rem; background: var(--bg-main); border-top: 1px solid var(--border-color);">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <?php echo form_submit('submit', 'Créer le groupe', array('class' => 'btn btn-primary')); ?>
                </div>
            </div>

...
<div class = "row">
	<div class = "col-md-offset-4 col-md-8 col-md-offset-2">
		<?php echo form_open('', array('class' => 'well'));?>
			<?php echo form_fieldset('CREATION D\'UN NOUVEAU GROUPE UTILISATEUR');?>
			<div class="formulaire">
				<div class="row">
					...
					<div  class="col-md-9">
						<input  value = "<?php echo set_value('group_name');?>" type="text" name = "group_name" class="form-control tooltip-input" required title = "Entrez le nom du groupe." />
